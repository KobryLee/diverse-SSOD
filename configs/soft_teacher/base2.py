...
model = dict(
    backbone=dict(
        ...
        style="caffe",
        init_cfg=dict(
            type="Pretrained", checkpoint="pretrain/resnet50.pth"
        ),
    )
)
...
strong_pipeline = [
    ...
    dict(type="Pad", size_divisor=32),
    dict(type="Normalize", **img_norm_cfg),
    dict(type="ExtraAttrs", tag="unsup_student_strong"),
    dict(type="DefaultFormatBundle"),
    dict(
        type="Collect",
        keys=["img", "gt_bboxes", "gt_labels"],
...
strong_pipeline2 = [
    ...
    dict(type="Pad", size_divisor=32),
    dict(type="Normalize", **img_norm_cfg),
    dict(type="ExtraAttrs", tag="unsup_student2_strong"),
    dict(type="DefaultFormatBundle"),
    dict(
        type="Collect",
        keys=["img", "gt_bboxes", "gt_labels"],
...
weak_pipeline = [
    ...
    dict(type="Pad", size_divisor=32),
    dict(type="Normalize", **img_norm_cfg),
    dict(type="ExtraAttrs", tag="teacher_weak"),
    dict(type="DefaultFormatBundle"),
    dict(
        type="Collect",
        keys=["img", "gt_bboxes", "gt_labels"],
...
weak_pipeline2 = [
    ...
    dict(type="Pad", size_divisor=32),
    dict(type="Normalize", **img_norm_cfg),
    dict(type="ExtraAttrs", tag="teacher2_weak"),
    dict(type="DefaultFormatBundle"),
    dict(
        type="Collect",
        keys=["img", "gt_bboxes", "gt_labels"],
...
#     dict(type="LoadAnnotations", with_bbox=True),
    ...
    dict(
        type="MultiBranch", st=strong_pipeline,st2=strong_pipeline2, st3=weak_pipeline,st4=weak_pipeline2,
    ),
]
...
lr_config = dict(step=[179990, 179995])
